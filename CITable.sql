...
-- 1. DANH MỤC & CẤU HÌNH
CREATE TABLE VaiTro (
    IDVaiTro VARCHAR(10) PRIMARY KEY , --VT01_NV
    TenVaiTro NVARCHAR(50) NOT NULL
);

CREATE TABLE LoaiXe (
    IDLoaiXe VARCHAR(10) PRIMARY KEY , --LX01_O4
    TenLoaiXe NVARCHAR(50) NOT NULL
);

CREATE TABLE CaLam (
    IDCaLam VARCHAR(8) PRIMARY KEY ,-- CL01_S
    TenCa NVARCHAR(50),
    TgianBatDau TIME,
    TgianKetThuc TIME,
    HeSoLuong FLOAT
...
CREATE TABLE TaiKhoan (
    IDTaiKhoan VARCHAR(15) PRIMARY KEY ,--TK00001_KH
...
CREATE TABLE NhanVien (
    IDNhanVien VARCHAR(10) PRIMARY KEY ,--NV001_BV
...
CREATE TABLE KhachHang (
    IDKhachHang VARCHAR(12) PRIMARY KEY ,--KH00001_VI
...
CREATE TABLE ChuBaiXe (
    IDChuBaiXe VARCHAR(8) PRIMARY KEY ,--CB001
...
-- 4. CẤU TRÚC BÃI ĐỖ
CREATE TABLE BaiDo (
    IDBaiDo VARCHAR(8) PRIMARY KEY ,--BD001
...
CREATE TABLE KhuVuc (
    IDKhuVuc VARCHAR(10) PRIMARY KEY ,--KV001_A
...
CREATE TABLE ChoDauXe (
    IDChoDauXe VARCHAR(12) PRIMARY KEY ,--CD0001_A
...
CREATE TABLE ThietBi (
    IDThietBi VARCHAR(10) PRIMARY KEY, --TB001_CA
...
CREATE TABLE BangGia (
    IDBangGia VARCHAR(10) PRIMARY KEY ,--BG001_O4
...
CREATE TABLE LoaiHinhTinhPhi (
    IDLoaiHinhTinhPhi VARCHAR(15) PRIMARY KEY ,--LH001_GIO_O4
...
CREATE TABLE KhungGio (
    IDKhungGio VARCHAR(10) PRIMARY KEY,--KG01_HC
...
CREATE TABLE TheXeThang (
    IDTheThang VARCHAR(12) PRIMARY KEY ,--TXT001_12T
...
CREATE TABLE Voucher (
    IDVoucher VARCHAR(10) PRIMARY KEY ,--VC00001
...
-- 6. NGHIỆP VỤ (CORE)
CREATE TABLE DatCho (
    IDDatCho VARCHAR(20) PRIMARY KEY ,--DC0001_05012026
    IDKhachHangNo VARCHAR(12) NOT NULL,
    IDXeNo VARCHAR(12) NOT NULL,
...
CREATE TABLE HoaDon (
    IDHoaDon VARCHAR(20) PRIMARY KEY,--HD0001_05012026
    ThanhTien DECIMAL(18,2),
    NgayTao DATETIME DEFAULT GETDATE(),
    LoaiHoaDon NVARCHAR(50),
    IDVoucher VARCHAR(10) CONSTRAINT FK_HoaDon_Voucher FOREIGN KEY REFERENCES Voucher(IDVoucher) 
            ON UPDATE NO ACTION 
            ON DELETE SET NULL 
);

CREATE TABLE PhieuGiuXe (
    IDPhieuGiuXe VARCHAR(15) PRIMARY KEY,--PX0001_A0001
...
CREATE TABLE ChiTietHoaDon (
    IDChiTietHoaDon VARCHAR(20) PRIMARY KEY,--CTHD0001_HD0001
...
CREATE TABLE ThanhToan (
    IDThanhToan VARCHAR(12) PRIMARY KEY ,--TT00001_CK
...
CREATE TABLE LichLamViec (
    IDLichLamViec VARCHAR(15) PRIMARY KEY,--LLV00001_001
...
CREATE TABLE SuCo (
    IDSuCo VARCHAR(10) PRIMARY KEY ,--SC001_CA
...
CREATE TABLE DanhGia (
    IDDanhGia VARCHAR(12) PRIMARY KEY ,--DG001_0001
...
('VC00001', 'BD001', N'Giảm 20K', 20000,
 '2026-12-31', 100, 1, 'VC20K'),
 ('VC00002', 'BD001', N'Giảm 10%', 10000, '2026-06-30', 200, 1, 'G10P'),
('VC00003', 'BD002', N'Giảm 50K sân bay', 50000, '2026-12-31', 100, 1, 'SB50K'),
('VC00004', 'BD003', N'Khuyến mãi bảo trì', 30000, '2025-12-31', 50, 0, 'KM30K');
...
('HD0001_05012026', 80000, GETDATE(), N'Giữ xe', 'VC00001');
